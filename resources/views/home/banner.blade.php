@section('banner')
    <div class="banner">
        <div class="container links d-flex align-items-center justify-content-center flex-column"
            ...
            <p style="font-size: 3.8em;" class="fw-bold text-uppercase text-center">" Direcionar conhecimento e
                tecnologia para transformar
                pessoas."</p>
            <a href="#news" class="btn bg-success text-uppercase fs-7 fw-bold px-4 py-2 mt-4">Descubra mais</a>
        </div>
    </div>
@endsection
