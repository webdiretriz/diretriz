    ...
    <section class="client" style="background: #1C1E22">
        <div class="container py-5">
            <h1 class='title-section text-white fs-3'>Temos a confiança de mais de 5.000 clientes satisfeitos em todo o
                Brasil!</h1>
            <div class="w-100 d-flex mt-5 flex-wrap flex-xl-nowrap align-items-center justify-content-center">
                <img src="{{url(mix('images/mapa.png'))}}" style="max-width: 80%" alt="mapa">
